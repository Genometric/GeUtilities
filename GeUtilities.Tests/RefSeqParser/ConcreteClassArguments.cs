...
namespace GeUtilities.Tests.TRefSeqParser
{
    public class ConcreteClassArguments
    {
        ...
        public void ReadStrand(char strand)
        {
            ...
            {
                // Act
                RefSeqParser genesParser = new RefSeqParser(
        ...
        public void FailReadRefSeqID()
        {
            ...
            {
                // Act
                RefSeqParser parser = new RefSeqParser(testFile.TempFilePath, 0, 1, 2, 10, 4);
                var parsedData = parser.Parse();
        ...
        public void FailReadGeneSymbol()
        {
            ...
            {
                // Act
                RefSeqParser parser = new RefSeqParser(testFile.TempFilePath, 0, 1, 2, 3, 10);
                var parsedData = parser.Parse();
        ...
        public void AvoidHeader(int headerCount, byte startOffset)
        {
            ...
            {
                // Act
                RefSeqParser parser = new RefSeqParser(testFile.TempFilePath, startOffset: startOffset);
                var parsedData = parser.Parse();
